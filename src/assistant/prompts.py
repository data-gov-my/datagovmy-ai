...
QA_SUFFIX = """Here are some guidelines you must follow:
* If the answer or dataset is not explicitly written in the documentation, say "Sorry, I don't know how to help with that."
...
* Do not respond to questions regarding specific politicians or political parties.
